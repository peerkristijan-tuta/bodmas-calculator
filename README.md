...
a) Operands +, -, /, or x grouped together. The program cannot distinguish between +--+- (perfectly valid) and x/ (invalid), and will flag both for diagnosis but won't display any diagnosis information.
